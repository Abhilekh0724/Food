...
import AddDonorInfo from "./donor";

const steps = [
  { id: "1", name: "Basic Info" },
  { id: "2", name: "Donor Info" },
  { id: "3", name: "Address Info" },
];

const AddDonorPage = ({ isEdit = false }: { isEdit?: boolean }) => {
  ...
  return (
    <div className="">
      ...
      <div className="">
        ...
        {currentStep === 1 && <AddDonorInfo isEdit={isEdit} />}
        {currentStep === 2 && <AddAddressInfo isEdit={isEdit} />}
